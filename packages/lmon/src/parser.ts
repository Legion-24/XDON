...
import { LMONParseError } from './errors';
...
export function parseToAST(input: string, _options?: ParseOptions): LMONDocument {
...
function evaluate(
  ...
  if (hasLabels && !allHaveLabels) {
    throw new LMONParseError('Mixed labeled and unlabeled rows', 0, 0);
  }
